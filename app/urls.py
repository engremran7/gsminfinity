...
urlpatterns = [
    ...
    # Django Summernote - DISABLED (using manual Summernote initialization with local files)
    ...
    path("api/storage/", include(("apps.storage.urls", "storage"), namespace="storage")),
    path("api/firmwares/", include(("apps.firmwares.urls", "firmwares"), namespace="firmwares")),
