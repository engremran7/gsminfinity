...
class AdUnitInline(admin.TabularInline):
    model = AdUnit
    extra = 0
    fields = ("name", "unit_id", "ad_format", "size_label", "is_enabled", "estimated_cpm")


@admin.register(AdNetwork)
class AdNetworkAdmin(admin.ModelAdmin):
    list_display = (
        "name", "network_type", "is_enabled", "priority",
        "supports_display", "supports_video", "supports_rewarded", "last_sync_at"
    )
    list_filter = ("network_type", "is_enabled", "supports_display", "supports_video", "supports_rewarded")
    ...
    fieldsets = (
        ...
        ("Capabilities", {
            "fields": (
                "supports_display", "supports_native", "supports_video",
                "supports_rewarded", "supports_auto_ads"
            ),
        }),
        ("Revenue", {
...
class AdUnitAdmin(admin.ModelAdmin):
    list_display = ("name", "network", "unit_id", "ad_format", "size_label", "is_enabled", "estimated_cpm", "fill_rate")
...
class RewardedAdConfigAdmin(admin.ModelAdmin):
    list_display = (
        "name", "reward_type", "reward_amount", "is_enabled",
        "cooldown_minutes", "daily_limit_per_user"
    )
    ...
    fieldsets = (
        ...
        ("Limits", {
            "fields": ("cooldown_minutes", "daily_limit_per_user", "min_watch_seconds")
        }),
        ("Audit", {
            "fields": ("created_by", "updated_by"),
            "classes": ("collapse",),
...
class RewardedAdViewAdmin(admin.ModelAdmin):
    list_display = (
        "user", "config", "status", "reward_granted",
        "reward_amount", "watch_duration_seconds", "created_at"
    )
    list_filter = ("status", "reward_granted", "config")
    search_fields = ("user__email", "user__username")
    readonly_fields = (
        "user", "config", "started_at", "completed_at", "watch_duration_seconds",
...
class AffiliateProviderAdmin(admin.ModelAdmin):
    list_display = (
        "name", "provider_type", "is_enabled", "priority", "products_count"
    )
    ...
    fieldsets = (
        ...
        ("Configuration", {
            "fields": ("api_endpoint", "api_region", "marketplace", "default_tracking_params"),
            "classes": ("collapse",),
        }),
        ("Revenue", {
...
class AffiliateProductMatchInline(admin.TabularInline):
    ...
    extra = 0
    fields = ("brand", "model", "variant", "blog_post", "match_type", "relevance_score", "is_pinned", "is_hidden")
...
class AffiliateProductAdmin(admin.ModelAdmin):
    list_display = (
        "name", "provider", "product_type", "display_price", "rating_stars",
        "is_enabled", "is_in_stock", "clicks", "conversions"
    )
    list_filter = ("provider", "product_type", "category", "is_enabled", "is_in_stock", "is_universal")
    search_fields = ("name", "external_id", "asin", "target_keywords")
    exclude = ("is_deleted", "deleted_at", "deleted_by")
    readonly_fields = ("created_by", "updated_by", "price_updated_at", "impressions", "clicks", "conversions", "revenue")
    ...
    fieldsets = (
        ...
        ("Targeting", {
            "fields": ("target_brands", "target_models", "target_keywords", "is_universal"),
        }),
        ("Status", {
            "fields": ("is_enabled", "is_in_stock", "availability_message"),
        }),
        ("Performance", {
            "fields": ("impressions", "clicks", "conversions", "revenue", "ai_relevance_score"),
            "classes": ("collapse",),
        }),
        ("API Data", {
            "fields": ("api_data",),
    ...
    def display_price(self, obj):
        ...
        if obj.sale_price and obj.sale_price < obj.price:
            return format_html(
                ...
                obj.currency, obj.price, obj.currency, obj.sale_price
            )
...
class AffiliateProductMatchAdmin(admin.ModelAdmin):
    list_display = ("product", "target_display", "match_type", "relevance_score", "is_pinned", "is_hidden")
...
class AffiliateClickAdmin(admin.ModelAdmin):
    ...
    readonly_fields = (
        "product", "provider", "user", "session_id",
...
class AdsSettingsAdmin(SingletonModelAdmin):
    ...
    fieldsets = (
        ("Master Controls", {
            "fields": (
                "ads_enabled", "affiliate_enabled", "ad_networks_enabled", "ad_aggressiveness_level"
            ),
        }),
        ("Auto Ads", {
            "fields": (
                "auto_ads_enabled", "auto_ads_scan_interval",
                "auto_ads_in_article", "auto_ads_in_feed",
                "auto_ads_anchor", "auto_ads_vignette", "auto_ads_sidebar"
            ),
            "classes": ("collapse",),
        }),
        ("Rewarded Ads", {
            "fields": (
                "rewarded_ads_enabled", "rewarded_ads_reward_type",
                "rewarded_ads_reward_value", "rewarded_ads_cooldown_minutes",
        ...
        ("Affiliate Products", {
            "fields": (
                "affiliate_products_enabled", "affiliate_products_max_per_page",
                "affiliate_products_cache_hours", "affiliate_products_auto_fetch",
                "affiliate_products_show_on_firmware", "affiliate_products_show_on_model",
                "affiliate_products_show_on_brand", "affiliate_products_show_on_blog",
        ...
        ("Amazon Product API", {
            "fields": (
                "amazon_paapi_enabled", "amazon_paapi_access_key",
        ...
        ("Google AdSense", {
            "fields": ("adsense_enabled", "adsense_publisher_id", "adsense_auto_ads"),
            "classes": ("collapse",),
        }),
        ("Media.net", {
        ...
        ("Premium Networks", {
            "fields": (
                ...
                "adthrive_enabled", "adthrive_site_id",
                "mediavine_enabled", "mediavine_site_id"
            ),
            "classes": ("collapse",),
        }),
        ("Other Networks", {
            "fields": (
                "propellerads_enabled", "propellerads_zone_id",
                "amazon_ads_enabled", "amazon_ads_publisher_id",
                "infolinks_enabled", "infolinks_pid",
                "carbon_enabled", "carbon_serve_id",
                "buysellads_enabled", "buysellads_zone_id"
            ),
            "classes": ("collapse",),
        }),
        ("Header Bidding", {
            "fields": ("header_bidding_enabled", "prebid_timeout_ms", "prebid_bidders"),
            "classes": ("collapse",),
        }),
        ("Native Ads", {
        ...
        ("AI Optimization", {
            "fields": (
                "ai_optimization_enabled", "ai_model_provider",
                "ai_optimize_placements", "ai_optimize_creatives", "ai_optimize_bidding"
            ),
            "classes": ("collapse",),
        }),
        ("Consent & Privacy", {
            "fields": (
                "require_consent", "consent_mode_default",
                "show_ads_without_consent", "tcf_enabled"
            ),
            "classes": ("collapse",),
        }),
        ("Frequency & Limits", {
            "fields": (
                "max_ads_per_page", "min_content_between_ads",
                "refresh_interval_seconds", "lazy_load_ads"
            ),
            "classes": ("collapse",),
        }),
        ("Exclusions", {
            "fields": ("excluded_pages", "excluded_categories", "excluded_user_roles"),
            "classes": ("collapse",),
        }),
