...
class NotificationService(ABC):
    ...
    @abstractmethod
    def send(self, user_id: int, title: str, message: str, notification_type: str = 'info', **kwargs) -> bool:
        """Send a notification to a user"""
        pass
    
    @abstractmethod
    def send_bulk(self, user_ids: List[int], title: str, message: str, notification_type: str = 'info') -> int:
