# Generated by Django 5.2.8 on 2025-12-07 19:53
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('devices', '0003_deviceconfig_risk_mfa_threshold'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['user'], name='devices_use_user_id_a5e3ba_idx')],
            },
        ),
    ]
