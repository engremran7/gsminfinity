...
def auto_translate_key(self, key_id: int, target_locale: str, provider: str | None = None):
    """
...
def batch_translate_locale(self, app_id: str, target_locale: str, namespace: str | None = None, limit: int = 100):
    """
