...
from apps.i18n_themes.models import AppManifest, FontRegistry, LanguageProfile, Locale, Theme, ThemeAssignment


class Command(BaseCommand):
    help = "Seed i18n_themes with default locales, fonts, language profiles, and manifests for common apps."
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS("i18n_themes seeding complete."))
