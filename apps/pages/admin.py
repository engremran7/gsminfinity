...
class PageAdmin(admin.ModelAdmin):
    list_display = ("title", "slug", "status", "access_level", "include_in_sitemap", "last_modified")
    ...
    fieldsets = (
        ("Content", {"fields": ("title", "slug", "content", "content_format", "status", "access_level")}),
        ("Publishing", {"fields": ("publish_at", "unpublish_at")}),
        ("SEO", {"fields": ("seo_title", "seo_description", "og_image", "canonical_url")}),
        (
            "Sitemap",
            {
                "fields": (
