...
class SharedDriveAccountSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'name', 'drive_id', 'max_files', 'current_file_count',
            'utilization_percent', 'available_slots', 'total_size_gb',
            'health_status', 'is_active', 'priority', 'active_service_accounts',
            'last_health_check'
        ]
...
class ServiceAccountSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'name', 'email', 'shared_drive', 'daily_quota_gb',
            'used_quota_today_gb', 'available_quota_gb', 'is_active',
            'is_banned', 'consecutive_failures', 'average_speed_mbps',
            'total_operations', 'last_used_at'
        ]
        read_only_fields = [
...
class FirmwareStorageLocationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'storage_type', 'file_name', 'file_size_bytes',
            'file_size_gb', 'is_primary', 'is_verified', 'priority',
            'download_count', 'consecutive_failures', 'is_available',
...
class UserDownloadSessionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'status', 'file_name', 'file_size', 'user_gdrive_link',
...
class DriveFileOrganizationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'shared_drive', 'folder_path', 'file_count',
            'size_gb', 'created_at'
        ]
...
class InitiateDownloadSerializer(serializers.Serializer):
    ...
    firmware_type = serializers.ChoiceField(
        choices=[
            'official', 'engineering', 'readback',
            'modified', 'other', 'unclassified'
        ],
