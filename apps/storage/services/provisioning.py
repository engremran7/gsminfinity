...
class CloudStorageProvisioner:
    ...
    def provision_google_service_account(
        ...
        try:
            ...
            if shared_drive:
                ...
                logger.info(f"{'Created' if created else 'Updated'} service account: {email}")
    ...
    def bulk_provision_google_service_accounts(
        self,
        provider,
        service_accounts_json: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
        """
    ...
    def fetch_google_shared_drives(self, provider) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.info(f"Found {len(drives)} shared drives for provider {provider.name}")
